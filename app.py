...
# ——————————————————————————————————————————————————————————————
with st.sidebar:
    st.image("https://raw.githubusercontent.com/yourusername/yourrepo/main/logo.png", width=150)
...
def show_about():
    ...
    st.image("https://raw.githubusercontent.com/yourusername/yourrepo/main/about_image.jpg", use_column_width=True)
    st.markdown("---")
...
def show_fleet():
    ...
    st.markdown(
        ...
        - **Wheelchair Van**  
          ![Wheelchair Van](https://raw.githubusercontent.com/yourusername/yourrepo/main/wheelchair_van.jpg)  
          *Equipped with hydraulic ramp, safety straps, and extra headroom.*
        
        - **Stretcher Van**  
          ![Stretcher Van](https://raw.githubusercontent.com/yourusername/yourrepo/main/stretcher_van.jpg)  
          *Reclining stretcher, oxygen mount, and medical storage cabinet.*
        
        - **Ambulatory Van**  
          ![Ambulatory Van](https://raw.githubusercontent.com/yourusername/yourrepo/main/ambulatory_van.jpg)  
...
def show_booking_form():
    ...
    with st.form(key="booking_form"):
        ...
        with col1:
            ...
            phone = st.text_input("Phone Number", placeholder="e.g., (503) 123-4567")
            ...
            appointment_date = st.date_input("Appointment Date", datetime.now().date())
            appointment_time = st.time_input("Appointment Time", datetime.now().time())
        
        with col2:
            assistance_type = st.selectbox(
                "Assistance Type",
                ["Wheelchair Transport", "Stretcher Transport", "Ambulatory Transport", "Other"]
            )
    ...
    if submit_button:
        st.success("✅ Thank you, **%s**! Your booking request has been received." % full_name)
...
def show_contact():
    ...
    if contact_submit:
        st.success("✅ Thank you, %s! Your message has been sent." % name)
...
def show_faq():
    ...
    faqs = {
        "Do you accept insurance?": "Yes. We bill most Medicaid and Medicare plans directly. We also accept major private insurers. Please have your insurance information handy when booking.",
        "How far in advance should I schedule my ride?": "We recommend booking at least 24 hours in advance. Same-day requests may be accommodated based on availability.",
        "Are your vehicles wheelchair accessible?": "Absolutely. All our vans are fully equipped with hydraulic wheelchair ramps, secure tie-downs, and seating to ensure safety and comfort.",
        "What if my appointment runs late?": "Please notify us as soon as possible. We’ll do our best to accommodate any changes, but additional fees may apply for extended wait times.",
        "Do you provide oxygen or medical monitoring?": "Yes. Our stretcher vans can be equipped with oxygen mounts. For extended medical monitoring, please inform us ahead of time so we can assign a certified EMT driver.",
        "What is your cancellation policy?": "Cancellations made 2 hours before the scheduled pickup time are free of charge. Late cancellations or no-shows may incur a fee."
    }
